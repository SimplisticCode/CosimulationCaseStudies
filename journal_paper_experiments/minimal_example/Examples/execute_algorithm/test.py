...
def executeAlgorithm(batch_mode, maestroJarPath):
    ...
    callBack = lambda: print("Succesfully written algorithm to masterModel.conf") if(masterModelPath) else lambda: (Exception("Master model was not generated"))
