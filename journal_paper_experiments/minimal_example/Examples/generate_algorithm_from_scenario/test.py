...
def generateAlgorithmFromScenario(maestroJarPath):
    ...
    callBack = lambda: print(f"Succesfully written algorithm to masterModel.conf in {resultsPath}") if(masterModelPath) else lambda: (Exception("Master model was not generated"))
